...
FlowRouter.route('/newProject', {
   ...
   action : function(){
      BlazeLayout.render("home", {content : "newProject"});
   }
});
...
FlowRouter.route('/projects/:projectId', {
   triggersEnter: [checkLoggedIn],
   action : function(params){
      BlazeLayout.render("appLayout",{content : "project", params: params})
   }
});
...
FlowRouter.route('/userProjects',{
   triggersEnter: [checkLoggedIn],
   action : function(){
      BlazeLayout.render("appLayout", {content : "userPro"})
   }
});
FlowRouter.route('/userWorkSpace',{
   triggersEnter: [checkLoggedIn],
   action : function(){
      BlazeLayout.render("appLayout", {content : "uWorkSpace"})
   }
});
FlowRouter.route('/userFiles',{
   triggersEnter: [checkLoggedIn],
   action : function(){
      BlazeLayout.render("appLayout", {content : "userDoc"})
   }
});
